...
//  Mate 내장 객체의 활용 : 각종 수학 상수, 함수들을 가진 내장 객체
console.log(Math.min(1, 3, 5, 2, 6, 7), Math.max(9, 2, 6, 2, 4));
let n3 = 3.567;
//  round : 반올림, floor : 버림
...
console.log(parseInt("011", 2));    //  011 -> 2진수 진법 변환 (int)
console.log(parseInt("123.456"));   //  123.456 -> 정수로 변환 -> 123

//  partInt : float -> int 변환할 때도 사용
console.log(Math.PI, parseInt(Math.PI));

let n4 = parseInt("abcd1234");  //  숫자로 변환할 수 없는 형태의 Casting
console.log(n4, "is", typeof n4); //  Nan -> number 이지만, 산술 연산이 불가한 수치
console.log(n4 + 10);   //  NaN 이 포함된 산술 연산식은 항상 NaN
//  NaN 인지 확인하려면 isNaN 함수 활용
