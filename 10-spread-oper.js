...
//  ES5 방법 2. concat 메소드 이용
combined = arr1.concat(arr2);   //  arr 배열에 arr2 를 연결하여 새 배열 생성
console.log("combined m2 : ", combined);

//  ES5 방법 3. 빈 배열에 concat 메소드 사용
...
let { one, two, other, ...othrs } = combined;
console.log("전개 : ", one, two, other, othrs);